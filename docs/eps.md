...
| [EP-0133](proposals/EP-0133-jupyter-cli-integration.md)        | Jupyter & CLI Integration                          | `algebrax.display`          | :material-check-all: Final |
...
| [EP-0152](proposals/EP-0152-spectral-graph-theory-laplacian.md)     | Spectral Graph Theory, Algebraic Connectivity & Graph Laplacians | ⚖️ Noether & ⚡ Shannon |  :material-pencil: Draft   |
