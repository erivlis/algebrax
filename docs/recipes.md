...
### 2D Image Processing
* **Files**: [`image_processing.py`](https://github.com/erivlis/algebrax/blob/main/recipes/image_processing.py) | [`image_processing.ipynb`](https://github.com/erivlis/algebrax/blob/main/recipes/image_processing.ipynb)
...
* **Files**: [`traffic_network_resilience.py`](https://github.com/erivlis/algebrax/blob/main/recipes/traffic_network_resilience.py) | [`traffic_network_resilience.ipynb`](https://github.com/erivlis/algebrax/blob/main/recipes/traffic_network_resilience.ipynb)
...
* **Files**: [`nlp_provenance_parser.py`](https://github.com/erivlis/algebrax/blob/main/recipes/nlp_provenance_parser.py) | [`nlp_provenance_parser.ipynb`](https://github.com/erivlis/algebrax/blob/main/recipes/nlp_provenance_parser.ipynb)
...
* **Files**: [`post_quantum_crypto_exchange.py`](https://github.com/erivlis/algebrax/blob/main/recipes/post_quantum_crypto_exchange.py) | [`post_quantum_crypto_exchange.ipynb`](https://github.com/erivlis/algebrax/blob/main/recipes/post_quantum_crypto_exchange.ipynb)
...
* **Files**: [`supply_chain_optimal_transport.py`](https://github.com/erivlis/algebrax/blob/main/recipes/supply_chain_optimal_transport.py) | [`supply_chain_optimal_transport.ipynb`](https://github.com/erivlis/algebrax/blob/main/recipes/supply_chain_optimal_transport.ipynb)
...
* **Files**: [`telecom_fractal_network.py`](https://github.com/erivlis/algebrax/blob/main/recipes/telecom_fractal_network.py) | [`telecom_fractal_network.ipynb`](https://github.com/erivlis/algebrax/blob/main/recipes/telecom_fractal_network.ipynb)
...
* **Files**: [`quantum_convex_optimization.py`](https://github.com/erivlis/algebrax/blob/main/recipes/quantum_convex_optimization.py) | [`quantum_convex_optimization.ipynb`](https://github.com/erivlis/algebrax/blob/main/recipes/quantum_convex_optimization.ipynb)
...
* **Files**: [`sensor_network_reliability.py`](https://github.com/erivlis/algebrax/blob/main/recipes/sensor_network_reliability.py) | [`sensor_network_reliability.ipynb`](https://github.com/erivlis/algebrax/blob/main/recipes/sensor_network_reliability.ipynb)
...
* **Files**: [`holographic_bulk_boundary.py`](https://github.com/erivlis/algebrax/blob/main/recipes/holographic_bulk_boundary.py) | [`holographic_bulk_boundary.ipynb`](https://github.com/erivlis/algebrax/blob/main/recipes/holographic_bulk_boundary.ipynb)
...
* **Files**: [`optical_holography_simulation.py`](https://github.com/erivlis/algebrax/blob/main/recipes/optical_holography_simulation.py) | [`optical_holography_simulation.ipynb`](https://github.com/erivlis/algebrax/blob/main/recipes/optical_holography_simulation.ipynb)
...
* **Files**: [`topological_data_analysis.py`](https://github.com/erivlis/algebrax/blob/main/recipes/topological_data_analysis.py) | [`topological_data_analysis.ipynb`](https://github.com/erivlis/algebrax/blob/main/recipes/topological_data_analysis.ipynb)
...
* **Files**: [`control_theory_state_space.py`](https://github.com/erivlis/algebrax/blob/main/recipes/control_theory_state_space.py) | [`control_theory_state_space.ipynb`](https://github.com/erivlis/algebrax/blob/main/recipes/control_theory_state_space.ipynb)
...
* **Files**: [`algebraic_knot_theory.py`](https://github.com/erivlis/algebrax/blob/main/recipes/algebraic_knot_theory.py) | [`algebraic_knot_theory.ipynb`](https://github.com/erivlis/algebrax/blob/main/recipes/algebraic_knot_theory.ipynb)
...
* **Files**: [`sheaf_cohomology_consensus.py`](https://github.com/erivlis/algebrax/blob/main/recipes/sheaf_cohomology_consensus.py) | [`sheaf_cohomology_consensus.ipynb`](https://github.com/erivlis/algebrax/blob/main/recipes/sheaf_cohomology_consensus.ipynb)
...
* **Files**: [`trajectoid_rolling_kinematics.py`](https://github.com/erivlis/algebrax/blob/main/recipes/trajectoid_rolling_kinematics.py) | [`trajectoid_rolling_kinematics.ipynb`](https://github.com/erivlis/algebrax/blob/main/recipes/trajectoid_rolling_kinematics.ipynb)
...
* **Files**: [`sparse_tensor_einsum.py`](https://github.com/erivlis/algebrax/blob/main/recipes/sparse_tensor_einsum.py) | [`sparse_tensor_einsum.ipynb`](https://github.com/erivlis/algebrax/blob/main/recipes/sparse_tensor_einsum.ipynb)
...
* **Files**: [`blackhole_spacetime_simulation.py`](https://github.com/erivlis/algebrax/blob/main/recipes/blackhole_spacetime_simulation.py) | [`blackhole_spacetime_simulation.ipynb`](https://github.com/erivlis/algebrax/blob/main/recipes/blackhole_spacetime_simulation.ipynb)
