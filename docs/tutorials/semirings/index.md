...
%% Click Navigation Links
    click Standard "semiring_standard.md" "StandardSemiring Tutorial"
    click Modular "semiring_modular.md" "ModularSemiring Tutorial"
    click Tropical "semiring_tropical.md" "TropicalSemiring Tutorial"
    click Arctic "semiring_tropical.md" "ArcticSemiring Tutorial"
    click Viterbi "semiring_viterbi.md" "ViterbiSemiring Tutorial"
    click Reliability "semiring_viterbi.md" "ReliabilitySemiring Tutorial"
    click Bottleneck "semiring_bottleneck.md" "BottleneckSemiring Tutorial"
    click MinTimes "semiring_bottleneck.md" "MinTimesSemiring Tutorial"
    click Boolean "semiring_boolean.md" "BooleanSemiring Tutorial"
    click Digital "semiring_digital.md" "DigitalSemiring Tutorial"
    click Lukasiewicz "semiring_logic_fuzzy.md" "LukasiewiczSemiring Tutorial"
    click String "semiring_logic_fuzzy.md" "StringSemiring Tutorial"
    click KCollapsed "semiring_logic_fuzzy.md" "KCollapsedSemiring Tutorial"
    click Log "semiring_statistical.md" "LogSemiring Tutorial"
    ...
    click Knot "semiring_knot.md" "KnotSemiring Tutorial"
    click QuotientAlg "semiring_quotient_monoid_algebra.md" "QuotientMonoidAlgebraSemiring Tutorial"
    click Clifford "semiring_clifford.md" "CliffordSemiring Tutorial"
    click GCA "semiring_clifford.md#generalized-clifford-algebras-gcas-clock-and-shift" "GeneralizedCliffordSemiring Tutorial"
    click QuantumClifford "semiring_clifford.md#q-deformed-quantum-clifford-algebras" "QuantumCliffordSemiring Tutorial"
    click GaloisField "semiring_galois.md" "GaloisFieldSemiring Tutorial"
...
For more details, see the [Algebraic Law Verification Tutorial](algebraic_law_verification.md).
